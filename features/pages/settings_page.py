...
class SettingsPageElements(object):
    ...
    # folder elements
    ADD_FOLDER = '//*[contains(text(), "Create new label")]' # '//*[@id=":7h"]'
    FOLDER_NAME = '//*[@id=":7p.na"]'
    FOLDER_SUBMIT = '/html/body/div[27]/div[3]/button[1]'
...
class SettingsPage(Browser):
    ...
    def create_folder(self, name):
        ...
        create_folder_button = self.driver.find_element_by_link_text(SettingsPageElements.ADD_FOLDER)
    ...
    def folder_success(self):
        self.driver.find_element_by_link_text('Test Folder').click()
